    ...
    .all(
      [].concat(
        ...
        },
        {
          ...
          errors: [
            errorMessage("aria-checked", "complementary", "aside", true),
          ],
        },
        {
        ...
        },
        {
          ...
          errors: [
            errorMessage("aria-expanded", "complementary", "aside", true),
          ],
        },
        {
        ...
        },
        {
          ...
          errors: [
            errorMessage("aria-selected", "menuitemradio", "menuitem", true),
          ],
        },
        {
