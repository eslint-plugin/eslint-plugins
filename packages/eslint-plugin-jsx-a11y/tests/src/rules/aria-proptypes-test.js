...
const errorMessage = (name) => {
  ...
  switch (type) {
    case "tristate":
      return {
        message: `The value for ${name} must be a boolean or the string "mixed".`,
      };
    case "token":
      return {
        message: `The value for ${name} must be a single token from the following: ${permittedValues}.`,
      };
    case "tokenlist":
      return {
...
tokens from the following: ${permittedValues}.`,
    ...
    case "idlist":
      return {
        message: `The value for ${name} must be a list of strings that represent DOM element IDs (idlist)`,
      };
    case "id":
      return {
        message: `The value for ${name} must be a string that represents a DOM element ID`,
      };
    case "boolean":
    case "string":
    case "integer":
