...
module.exports = {
  ...
  create(context) {
    return {
      ':function[async=false][generator=false]>BlockStatement>:first-child[expression.value="use server"]'(
        node,
      ) {
        ...
        const suggestMessage = name
          ? messages.suggestAsyncNamed
          : messages.suggestAsyncAnon;
