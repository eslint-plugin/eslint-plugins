...
const ruleNoUnusedVars = require("../../helpers/getESLintCoreRule")(
  "no-unused-vars",
);

const rulePreferConst = require("../../helpers/getESLintCoreRule")(
  "prefer-const",
);
...
ruleDefiner.defineRule(
  "react/jsx-uses-vars",
  require("../../../lib/rules/jsx-uses-vars"),
);
...
ruleTester.run("prefer-const", rulePreferConst, {
  ...
  invalid: parsers.all(
    [
      ...
      `,
        errors: [
          { message: "'App' is never reassigned. Use 'const' instead." },
        ],
        output: `
        /* eslint react/jsx-uses-vars:1 */
        const App = <div />;
