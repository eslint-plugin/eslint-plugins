  ...
  invalid: parsers.all([
    {
      ...
      output:
        '<a target="_blank" href="https://example.com/1" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" rel="" href="https://example.com/2"></a>',
      output:
        '<a target="_blank" rel="noreferrer" href="https://example.com/2"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" rel={0} href="https://example.com/3"></a>',
      output:
        '<a target="_blank" rel="noreferrer" href="https://example.com/3"></a>',
      errors: defaultErrors,
    },
    {
    ...
    },
    {
      ...
      output:
        '<a target="_blank" rel="noreferrer" href="https://example.com/4"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" rel={null} href="https://example.com/5"></a>',
      output:
        '<a target="_blank" rel="noreferrer" href="https://example.com/5"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" rel="noopenernoreferrer" href="https://example.com/6"></a>',
      output:
        '<a target="_blank" rel="noopener noreferrer" href="https://example.com/6"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" rel="no referrer" href="https://example.com/7"></a>',
      output:
        '<a target="_blank" rel="no referrer noreferrer" href="https://example.com/7"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_BLANK" href="https://example.com/8"></a>',
      output:
        '<a target="_BLANK" href="https://example.com/8" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
    ...
    },
    {
      ...
      output:
        '<a target="_blank" href="//example.com/10" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" href="//example.com/11" rel={3}></a>',
      output:
        '<a target="_blank" href="//example.com/11" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" href="//example.com/12" rel={null}></a>',
      output:
        '<a target="_blank" href="//example.com/12" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
    ...
    },
    {
      ...
      output:
        '<a target="_blank" href="//example.com/14" rel={"noopener noreferrer"}></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target={"_blank"} href={"//example.com/15"} rel={"noopenernoreferrer"}></a>',
      output:
        '<a target={"_blank"} href={"//example.com/15"} rel={"noopener noreferrer"}></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target={"_blank"} href={"//example.com/16"} rel={"noopenernoreferrernoreferrernoreferrernoreferrernoreferrer"}></a>',
      output:
        '<a target={"_blank"} href={"//example.com/16"} rel={"noopener noreferrer"}></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" href="//example.com/17" rel></a>',
      output:
        '<a target="_blank" href="//example.com/17" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target="_blank" href={ dynamicLink }></a>',
    ...
    },
    {
      ...
      output:
        '<a target={\'_blank\'} href="//example.com/18" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a target={"_blank"} href="//example.com/19"></a>',
      output:
        '<a target={"_blank"} href="//example.com/19" rel="noreferrer"></a>',
      errors: defaultErrors,
    },
    {
      code: '<a href="https://example.com/20" target="_blank" rel></a>',
      output:
        '<a href="https://example.com/20" target="_blank" rel="noopener"></a>',
      options: [{ allowReferrer: true }],
    ...
    },
    {
      code: '<Link target="_blank" href={ dynamicLink }></Link>',
      output:
        '<Link target="_blank" href={ dynamicLink } rel="noreferrer"></Link>',
      options: [{ enforceDynamicLinks: "always" }],
      settings: { linkComponents: ["Link"] },
      errors: defaultErrors,
    },
    {
      code: '<Link target="_blank" to={ dynamicLink }></Link>',
      output:
        '<Link target="_blank" to={ dynamicLink } rel="noreferrer"></Link>',
      options: [{ enforceDynamicLinks: "always" }],
      settings: { linkComponents: { name: "Link", linkAttribute: "to" } },
      errors: defaultErrors,
    },
